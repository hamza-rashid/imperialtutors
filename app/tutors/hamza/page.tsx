      ...
      <Box bg="#F7F7F7" py={10}>
        <Container maxW={'6xl'}>
          ...
          <Text fontSize="sm" color="gray.600" mb={4}>
            <Link href="/" textDecoration="underline">Home</Link> {'>'} <Link href="/tutors" textDecoration="underline">Tutors</Link> {'>'} Hamza
          </Text>
          ...
          >
            <Box>
              ...
              <Heading as="h3" size="xs" mb={4}>
                Hamza is a professional educator. This means Hamza:
              </Heading>
