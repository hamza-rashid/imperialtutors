    ...
    <>
      ...
      <Box as="main" bg="#f7f7f7" py={{ base: 8, md: 12 }}>
        <Box maxW="1200px" mx="auto" px={{ base: 4, md: 6 }}>
          ...
          <Flex direction={{ base: 'column', md: 'row' }} gap={{ base: 8, md: 10 }} align="flex-start">
            {/* Left Column */}
            ...
            {/* Right Column */}
            <Box flex="1" bg="white" p={{ base: 4, md: 6 }} borderRadius="md" boxShadow="lg" w={{ base: '100%', md: 'auto' }}>
        ...
        <Box
            id="tutorbird-container" // Add this id here
            w="100%"
            mt={{ base: 12, md: 12 }} // More top margin
            mb={{ base: 4, md: 0 }} // More bottom margin
            bg="#37A169"
            pt={{ base: 12, md: 20 }} // Larger green padding top
            pb={{ base: 12, md: 20 }} // Larger green padding bottom
            >
