      ...
      <Container maxW={'7xl'}>
        <Stack
          ...
          <Stack flex={1} spacing={{ base: 5, md: 10 }}>
            ...
            <Text color={'gray.600'}>
              Join our online tuition with an <Text as="span" fontWeight="bold">Imperial College graduate, Dr. Hamza</Text>! In <Text as="span" fontWeight="bold">small groups</Text>, cover the entire GCSE & A-level Science and Maths syllabus.
