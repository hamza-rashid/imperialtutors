...
export default function CallToActionWithVideo() {
    ...
    return (
        <Container maxW={'7xl'}>
            <Stack
                ...
                <Stack flex={1} spacing={{ base: 5, md: 10 }}>
                    ...
                    <Text color={'gray.600'} fontSize={'xl'}>
                        Personalised Online Group Classes in <Text as="span" fontWeight="bold">Science & Maths for Year 7 to 13 by Top Graduates.</Text> Affordable Rates, Small Class Sizes, and Medical School Mentorship.
                    </Text>
                    <Stack
                        spacing={{ base: 4, sm: 6 }}
            ...
            <SimpleGrid columns={{ base: 1, sm: 2, md: 4 }} spacing={6} alignItems="center" justifyItems="center" mt={6} mb={12}>
