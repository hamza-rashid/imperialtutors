      ...
      <Container maxW={'7xl'}>
        <Stack
          ...
          <Stack flex={1} spacing={{ base: 5, md: 10 }}>
            ...
            <Text color={'gray.600'}>
            Join our online tuition with <Text as="span" fontWeight="bold">Imperial graduate Dr. Hamza</Text>! In small groups, cover the entire GCSE & A-level Science and Maths syllabus with 1.5 hours weekly per subject.</Text>
            <Text color={'gray.600'}>
